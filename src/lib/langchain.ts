...
export async function analyzeResume(
    ...
    try {
        ...
        console.log(`Original lengths - Resume: ${resume.length}, Job Description: ${jobDescription.length}, Skills: ${skills.length}`);
        console.log(`Truncated lengths - Resume: ${truncatedResume.length}, Job Description: ${truncatedJobDescription.length}, Skills: ${truncatedSkills.length}`);
        ...
        try {
            ...
            const requiredFields = ['score', 'strengths', 'weaknesses', 'keywords', 'improvement_suggestions'];
            ...
            throw new Error('Failed to parse response from language model: ' + errorMessage);
        }
    } catch (error) {
